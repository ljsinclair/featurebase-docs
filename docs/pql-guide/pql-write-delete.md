...
Note: while you could delete all records in an index using `Delete(All())`, this is not recommended, as [dropping an index](/docs/community/com-api/old-grpc-api#deleteindex) would be a much more performant way of deleting all records in an index.
