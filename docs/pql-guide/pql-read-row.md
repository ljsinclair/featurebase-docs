...
There are two different call definitions for `Row()`. One for Set, Mutex, and Time fields and another for Int, Decimal, and Timestamp fields. For more information on field types in FeatureBase, go [here](/docs/community/com-ingest/old-ingesters#field-types).
<!---
