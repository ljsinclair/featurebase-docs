...
Optionally, FeatureBase listens on port 55342 for the PostgreSQL wire protocol. It can accept [PQL](/docs/pql-guide/pql-home) queries, or a [subset of SQL](/docs/sql-guide/pql-guide-home) over this protocol.
