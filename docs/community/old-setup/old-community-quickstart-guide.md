...
>If you run into any roadblocks or have questions, please {% include contact-support.md %}
...
Next, configure the FeatureBase server by creating and running the configuration file. Go to [FeatureBase Configuration](/docs/community/com-config/com-config-flags) for more on configuring FeatureBase.
